...
exports.createRequestListener = function createRequestListener(pinbaPort, pinbaHost, isDebug) {
  var checkStructure = function checkStructure(jinbaRequest) {
    var error = false;
  ...
  var checkValues = function checkValues(jinbaRequest) {
    var error = false;
  ...
  var fixRequestTags = function fixRequestTags(jinbaRequest) {
    // Do nothing
  };
